    ...
    <div class="col-md-12">
        ...
        <div class="card-body pt-3 bg-light shadow-lg table-responsive">
            {!! Alert(
                $icon = 'fa-info',
                $class = 'alert-primary',
                $Title = $CourseName . ' Modular-Test Question Bank',
                $Msg = 'Manage all questions attached to the selected course Modular-Test ',
            ) !!}
