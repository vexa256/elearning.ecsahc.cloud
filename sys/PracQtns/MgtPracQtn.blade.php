    ...
    <div class="col-md-12">
        ...
        <div class="card-body pt-3 bg-light shadow-lg table-responsive">
            {!! Alert(
                $icon = 'fa-info',
                $class = 'alert-primary',
                $Title = $CourseName . ' Practical-Test Question Bank',
                $Msg =
                    'Manage all questions attached to the selected course module "' .
                    $ModuleName .
                    '"',
            ) !!}
...
@include('PracQtns.NewPracticalQuestions')

{{-- @include('ModularExams.NewModularExam') --}}
