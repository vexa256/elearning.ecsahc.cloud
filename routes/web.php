...
Route::middleware(['auth'])->group(function () {
    ...
    require __DIR__ . '/AttemptModular.php';
    require __DIR__ . '/AttemptPractical.php';
    require __DIR__ . '/AttemptPost.php';
    require __DIR__ . '/AttemptPre.php';
    require __DIR__ . '/Cert.php';
    ...
    Route::controller(MainController::class)->group(function () {
        ...
        // Route::any('Admin', 'console')->name('Admin');
        Route::any('AdminCP', 'console')->name('AdminCP');
