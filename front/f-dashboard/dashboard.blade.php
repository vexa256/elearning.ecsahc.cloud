                    ...
                    <div class="p-3">
                        ...
                        <div class="mt-3">
                            <a href="{{ route('StudentCourses') }}"
                                class="btn btn-primary	 shadow-lg">Course
                                Catalogue</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="card bg-secondary card-animate">
        <div class="card-body">
            <div class="d-flex justify-content-between">
                <div>
                    <p class="fw-medium text-light mb-0">Total Courses</p>
                    <h2 class="mt-4 ff-secondary text-light fw-semibold"><span
                            class="counter-value"
                            data-target="{{ $Courses }}">{{ $Courses }}</span>
                        Courses
                    </h2>
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between">
                <div>
                    ...
                    <h2 class="mt-4 ff-secondary text-light fw-semibold"><span
                            class="counter-value"
                            data-target="{{ $TotalAttempted }}">{{ $TotalAttempted }}</span>
                        Tests
                    </h2>
                    <p class="mb-0 text-muted"><span
                            class="badge bg-light text-dark mb-0"><i
