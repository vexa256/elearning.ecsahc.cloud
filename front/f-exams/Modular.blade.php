<div class="offcanvas offcanvas-start offcanvas-size-xl" tabindex="-1"
    id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvasExampleLabel">Select a modular
            exam to attempt
        </h5>
                                    ...
                                    <td>
                                        ...
                                        {!! ConfirmBtn(
                                            $data = [
                                                ...
                                                'route' => route('GoToModularExams', ['id' => $data->id]),
